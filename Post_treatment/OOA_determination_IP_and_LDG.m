...
new_resultIP=zeros(Nx,Ny+2*N5);
new_resultLDG=zeros(Nx,Ny+2*N5);
if 2+N3*N4~=Nx
    error('dimenesion N3 and N4 does not correspond to Nx!')
end
if 2+N5*(N2+(N2-1)+1)~=Ny
    error('dimenesion N2 and N5 does not correspond to Ny!')
end
for n=1:1:N5
    if n==1
...
for n=1:1:N5%Loop over tau
    for k=1:1:N3%loop over c
        for m=1:1:N4%loop over kappa
            OOA_arrayIP=resultIP(2+m+N4*(k-1),3+N2+(N2+(N2-1)+1)*(n-1):3+N2+(N2+(N2-1)+1)*(n-1)+N2-1-1);
            ...
            if n==1
                new_resultIP(2+m+N4*(k-1),3+(N2+(N2-1)+1)*(n-1)+N2+(N2-1)+1)=OOA_polyIP;
                new_resultIP(2+m+N4*(k-1),3+(N2+(N2-1)+1)*(n-1)+N2+(N2-1)+1+1)=R_2IP;
                %For LDG
                ...
                new_resultIP(2+m+N4*(k-1),3+3+(N2+(N2-1)+1)*(n-1)+N2+(N2-1)+1-1)=OOA_polyIP;
                new_resultIP(2+m+N4*(k-1),3+3+(N2+(N2-1)+1)*(n-1)+N2+(N2-1)+1)=R_2IP;
                %For LDG
            ...
            while fin==0
                ...
                switch m
                    case 1
                        kappa=cDG;
                        if k==1
                            OOAIP=new_resultIP(2+m+N4*(i-1),3+(N2+(N2-1)+1)*(k-1)+N2+(N2-1)+1);
                            OOALDG=new_resultLDG(2+m+N4*(i-1),3+(N2+(N2-1)+1)*(k-1)+N2+(N2-1)+1);
                        else
                            OOAIP=new_resultIP(2+m+N4*(i-1),3+3+(N2+(N2-1)+1)*(k-1)+N2+(N2-1)+1-1);
                            OOALDG=new_resultLDG(2+m+N4*(i-1),3+3+(N2+(N2-1)+1)*(k-1)+N2+(N2-1)+1-1);
                        end
                        aIP=plot(log10(kappa),OOAIP,'Marker','s','MarkerSize',6,'MarkerEdgeColor',couleurIP,'MarkerFaceColor',[0 0 0]);
                        hold on
                    ...
                    case 2
                        ...
                        bIP=plot(log10(kappa),OOAIP,'Marker','v','MarkerSize',6,'MarkerEdgeColor',couleurIP,'MarkerFaceColor',[0 0 0]);
                        hold on
                    ...
                    case 3
                        ...
                        eIP=plot(log10(kappa),OOAIP,'Marker','o','MarkerSize',6,'MarkerEdgeColor',couleurIP,'MarkerFaceColor',[0 0 0]);
                        hold on
                    ...
                    case 4
                        ...
                        dIP=plot(log10(kappa),OOAIP,'Marker','diamond','MarkerSize',6,'MarkerEdgeColor',couleurIP,'MarkerFaceColor',[0 0 0]);
                        hold on
                    ...
                    otherwise 
                        switch k
                            case 1
                                ...
                                OOA_arrayIP=new_resultIP(3+N4*(i-1):3+N4-1+N4*(i-1),3+(N2+(N2-1)+1)*(k-1)+N2+(N2-1)+1);
                                ...
                                OOA_arrayIP=B(:,2);
                                OOA_arrayLDG=B(:,3);
                                h1IP=plot(log10(kappa_array),OOA_arrayIP,'-+','Color',couleurIP,'LineWidth',1.0);
                                hold on
                            ...
                            case 2
                                ...
                                OOA_arrayLDG=new_resultLDG(3+N4*(i-1):3+N4-1+N4*(i-1),3+3+(N2+(N2-1)+1)*(k-1)+N2+(N2-1)+1-1);
                                ...
                                OOA_arrayIP=B(:,2);
                                OOA_arrayLDG=B(:,3);
                                h2IP=plot(log10(kappa_array),OOA_arrayIP,'-.+','Color',couleurIP,'LineWidth',1.0);
